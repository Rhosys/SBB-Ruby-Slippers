...
| Property | Value |
|----------|-------|
| Account ID | `981461567584` |
| Role | `GitLabRunnerRole` |
| Role ARN | `arn:aws:iam::981461567584:role/GitLabRunnerRole` |
| Region | `eu-west-1` |
...
The only CI/CD variable needed in GitLab project settings: `AWS_ACCOUNT_ID` = `981461567584`.
